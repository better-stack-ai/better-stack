/**
 * SSG Kanban boards list page with ISR.
 *
 * Call `revalidatePath("/pages/ssg-kanban", "page")` in your kanban
 * backend plugin hooks (lib/stack.ts) to purge the cache when boards change.
 */
