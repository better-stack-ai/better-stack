...
| `onBeforePost` | hook | — | Called before a comment is saved. Throw to reject. |
| `onAfterPost` | hook | — | Called after a comment is saved. |
| `onBeforeEdit` | hook | — | Called before a comment is updated. Throw to reject. |
| `onAfterEdit` | hook | — | Called after a comment is updated. |
