...
<AutoTypeTable path="../packages/better-stack/src/plugins/ai-chat/client/components/chat-layout.tsx" name="ChatLayoutProps" />
...
<AutoTypeTable path="../packages/better-stack/src/plugins/ai-chat/client/overrides.ts" name="ToolCallProps" />

#### ToolCallState

The possible states of a tool call:

<AutoTypeTable path="../packages/better-stack/src/plugins/ai-chat/client/overrides.ts" name="ToolCallState" />
