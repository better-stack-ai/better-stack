...
|------|------------|--------|-------------|
| `onBeforeListForms` | `ctx` | `void` | Authorization for listing forms; throw to deny |
...
| `onBeforeFormDeleted` | `id, ctx` | `void` | Authorization for delete; throw to deny |
...
| `onBeforeListSubmissions` | `formId, ctx` | `void` | Authorization for listing; throw to deny |
| `onBeforeSubmissionDeleted` | `id, ctx` | `void` | Authorization for delete; throw to deny |
