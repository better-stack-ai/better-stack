...
| `onBeforeFormCreated` | `data, ctx` | `data \| void` | Validate/transform before create; throw to reject invalid domain input |
...
| `onBeforeFormUpdated` | `id, data, ctx` | `data \| void` | Validate/transform before update; throw to reject invalid domain input |
| `onAfterFormUpdated` | `form, ctx` | `void` | Post-update lifecycle |
| `onBeforeFormDeleted` | `id, ctx` | `void` | Domain precondition before delete |
...
| `onBeforeSubmissionDeleted` | `id, ctx` | `void` | Domain precondition before deleting a submission |
