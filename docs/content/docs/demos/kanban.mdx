...
<iframe
  src="https://stackblitz.com/github/better-stack-ai/better-stack/tree/main/demos/kanban?startScript=dev&embed=1&file=lib%2Fstack.ts&view=preview&initialPath=%2Fpages%2Fkanban"
