...
#   5. Copies E2E overlay files from scripts/codegen/files/tanstack/ (overwrites)
...
step "Copying E2E overlay files from scripts/codegen/files/tanstack/"
cd "$DEST"
FILES_DIR="$SCRIPT_DIR/files/tanstack"
FILE_COUNT=0
