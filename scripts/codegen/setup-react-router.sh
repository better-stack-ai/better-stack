...
#   6. Applies surgical .patch files from scripts/codegen/patches/react-router/
...
rm -f "app/root.tsx" \
      ...
      "app/routes.ts"
# Note: app/lib/query-client.ts is intentionally kept (btst init version is correct)
