...
export const kanbanBackendPlugin = (hooks?: KanbanBackendHooks) =>
	defineBackendPlugin({
		...
		routes: (_adapter: Adapter, _context, operations) => {
			...
			return {
				listBoards: operations.listBoards.route(listBoards),
				getBoard: operations.getBoard.route(getBoard),
				createBoard: operations.createBoard.route(createBoard),
				updateBoard: operations.updateBoard.route(updateBoard),
				deleteBoard: operations.deleteBoard.route(deleteBoard),
				createColumn: operations.createColumn.route(createColumn),
				updateColumn: operations.updateColumn.route(updateColumn),
				deleteColumn: operations.deleteColumn.route(deleteColumn),
				reorderColumns: operations.reorderColumns.route(reorderColumns),
				createTask: operations.createTask.route(createTask),
				updateTask: operations.updateTask.route(updateTask),
				deleteTask: operations.deleteTask.route(deleteTask),
				moveTask: operations.moveTask.route(moveTask),
				reorderTasks: operations.reorderTasks.route(reorderTasks),
			} as const;
		},
	});
