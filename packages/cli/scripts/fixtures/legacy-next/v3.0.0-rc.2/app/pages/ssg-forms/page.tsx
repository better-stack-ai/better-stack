/**
 * SSG Forms list page with ISR.
 *
 * Call `revalidatePath("/pages/ssg-forms", "page")` in your form-builder
 * backend plugin hooks (lib/stack.ts) to purge the cache when forms change.
 */
